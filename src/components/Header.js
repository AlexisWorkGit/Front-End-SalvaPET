              ...
              <div className="col-12">
                  ...
                  <nav className="menu-nav show">
                    ...
                    <div className="navbar-wrap main-menu d-none d-lg-flex">
                      <ul className="navigation">
                        <li className="active menu-item-has-children"><Link to="/">Inicio</Link>
                          <ul className="submenu">
                            <li className="active" onClick={(e)=> subActive(e)}><Link to="/">Pagina de Inicio</Link></li>
                           </ul>
                        </li>
                      <li className="menu-item-has-children"><Link to="/shop" onClick={(e)=> handleActive(e)}>Tienda</Link>
                        ...
                        <li className="menu-item-has-children"><Link to="/breeder" onClick={(e)=> handleActive(e)}>Servicios Veterinarios</Link>
                          <ul className="submenu">
                            <li><Link to="/breeder" onClick={(e)=> subActive(e)}>Asistencia Sanitaria y Monitoreo Domiciliario</Link></li>
                            <li><Link to="/breeder-details" onClick={(e)=> subActive(e)}>Sistema Salva PET</Link></li>
                       
                          </ul>
                        </li>
                        <li className="menu-item-has-children"><Link to="/blogs" onClick={(e)=> handleActive(e)}>Blog</Link>
                          <ul className="submenu">
                            <li><Link to="/blogs"  onClick={(e)=> subActive(e)}>¿Qué es Salva PET?</Link></li>
                            <li><Link to="/blog-details" onClick={(e)=> subActive(e)}>Trabajos a Futuro</Link></li>
                          </ul>
                        </li>
                       {/* <li><Link to="/adoption" onClick={(e)=> handleActive(e)}>ASTR</Link></li>
                    */}
                        <li><Link to="/contacts" onClick={(e)=> handleActive(e)}>Contacto</Link></li>
                      </ul>
                    </div>
                    <div className="header-action d-none d-md-block">
                      <ul>
                        ...
                        <li className="header-btn"><Link to="/adoption" className="btn">Iniciar Sesión <img src="img/icon/w_pawprint.png" alt="" /></Link></li>
                      </ul>
                    </div>
                  </nav>
                </div>
                ...
                <div className="mobile-menu">
                  <nav className="menu-box">
                    ...
                    <div className="nav-logo"><Link to="/"><img src="img/logo/2.png" alt="" title='true' /></Link>
                    </div>
