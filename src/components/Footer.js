    ...
    <div className="footer-top-area footer-bg">
      <div className="container">
        <div className="row justify-content-between">
            ...
            <div className="footer-widget">
              ...
              <div className="footer-contact">
                ...
                <div className="content">
                  <h4 className="title"><a href="tel:0996535731">+ 593 99 653 5731</a></h4>
                  <span>Llamanos!</span>
                </div>
              </div>
          ...
          <div className="col-2">
            <div className="footer-widget">
              <h4 className="fw-title">Políticas</h4>
          ...
          <div className="col-2">
            <div className="footer-widget">
              <h4 className="fw-title">Servicios</h4>
              <div className="fw-link">
                <ul>
        ...
        <div className="row">
          <div className="col-md-8">
            <div className="copyright-text">
              <p>Copyright © 2022 Salva PET. Todos los derechos reservados.</p>
            </div>
          </div>
